...
namespace Fred
{
  public class VectorTransmission : Transmission
  {
    public void spread_infection(int day, int disease_id, MixingGroup mixing_group)
    {
      if (mixing_group == null || !(mixing_group is Place))
      {
      ...
      {
        this.spread_infection(day, disease_id, (Place)mixing_group);
      }
    }
    ...
    void spread_infection(int day, int disease_id, Place place)
    {
      ...
      var disease = Global.Diseases[disease_id];
