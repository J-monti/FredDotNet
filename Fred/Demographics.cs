...
namespace Fred
{
  public class Demographics
  {
    ...
    public const double MEAN_PREG_DAYS = 280.0; //40 weeks
    public const double STDDEV_PREG_DAYS = 7.0; //1 week

    private int m_InitialAge;
    private int race;
    private int relationship;
    private DateTime m_Day;

    public Demographics(Person person, int age, Gender sex, int race, int relationship, DateTime day, bool isNewBorn)
    {
      if (age > 89)
      {
        age = 90;
      ...
      {
        this.Birthday = day.AddYears(-age);
        this.Birthday = this.Birthday.AddDays(-(age / 4 - FredRandom.NextDayInYear()));
      }
    }
    ...
    initialize_demographic_dynamics(Person* self)
    {
