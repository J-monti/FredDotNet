...
namespace Fred
{
  public class Behavior
  {
    ...
    {
      int n = (int)BehaviorEnum.STAY_HOME_WHEN_SICK;
    ...
    {
      int n = (int)BehaviorEnum.TAKE_SICK_LEAVE;
      var my_intention = this.Intentions[n];
      if (my_intention == null)
      {
        return false;
    ...
    {
      int n = (int)BehaviorEnum.KEEP_CHILD_HOME_WHEN_SICK;
      var bParams = BehaviorParams[n];
      if (bParams.IsEnabled == false) {
        return false;
      }
    ...
    {
      int n = (int)BehaviorEnum.ACCEPT_VACCINE;
      var bParams = BehaviorParams[n];
      if (bParams.IsEnabled == false) {
        return false;
      }
    ...
    {
      int n = (int)BehaviorEnum.ACCEPT_VACCINE_DOSE;
      var bParams = BehaviorParams[n];
      if (bParams.IsEnabled == false) {
        return false;
      }
    ...
    {
      int n = (int)BehaviorEnum.ACCEPT_VACCINE_FOR_CHILD;
      var bParams = BehaviorParams[n];
      if (bParams.IsEnabled == false) {
        return false;
      }
    ...
    {
      int n = (int)BehaviorEnum.ACCEPT_VACCINE_DOSE_FOR_CHILD;
      var bParams = BehaviorParams[n];
      if (bParams.IsEnabled == false) {
        return false;
      }
