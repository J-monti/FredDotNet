...
namespace Fred
{
  public class RSAIntraHost : IntraHost
  {
    private const int MAX_LENGTH = 10;
    private double prob_symptomatic;
    private int id;
    private double symptoms_scaling;
    private double viral_infectivity_scaling;
    private int days_sick;
    private double lower_age_bound;
    private double upper_age_bound;
    private int age_severity_study_enabled;
