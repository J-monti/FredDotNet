...
namespace Fred
{
  public class MSEvolution : Evolution
  {
    ...
    double residual_immunity(Person* person, int challenge_strain, int day)
    {
    ...
    double prob_inoc(double quantity)
    {
    ...
    double prob_inf_blocking(int old_strain, int new_strain, int time, double real_age)
    {
    ...
    double prob_vac_blocking(int old_strain, int new_strain, int time, double real_age)
    {
      return prob_blocking(old_strain, new_strain, time, this.halflife_vac.find_value(real_age), this.init_prot_vac);
    }

    double prob_blocking(int old_strain, int new_strain, int time, double halflife, double init_prot)
    {
    ...
    double prob_past_infections(Person* infectee, int new_strain, int day)
    {
    ...
    double prob_past_vaccinations(Person* infectee, int new_strain, int day)
    {
      double probTaking = 1.0;
