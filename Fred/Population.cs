...
namespace Fred
{
  public class Population
  {
    ...
    private readonly AV_Manager m_AVManager;
    private readonly VaccineManager m_VaccineManager;
    ...
    public Population ()
    {
      ...
      this.m_AVManager = new AV_Manager();
      this.m_VaccineManager = new VaccineManager();
    }
