...
namespace Fred
{
  public class PlaceList
  {
    ...
    double College_dorm_mean_size = 3.5;
    double Military_barracks_mean_size = 12;
    double Prison_cell_mean_size = 1.5;
    double Nursing_home_room_mean_size = 1.5;

    // non-resident staff for group quarters
    int College_fixed_staff = 0;
    double College_resident_to_staff_ratio = 0;
    int Prison_fixed_staff = 0;
    double Prison_resident_to_staff_ratio = 0;
    int Nursing_home_fixed_staff = 0;
    double Nursing_home_resident_to_staff_ratio = 0;
    int Military_fixed_staff = 0;
    double Military_resident_to_staff_ratio = 0;
    int School_fixed_staff = 0;
    double School_student_teacher_ratio = 0;

    int Shelter_duration_mean = 0;
    int Shelter_duration_std = 0;
    int Shelter_delay_mean = 0;
    int Shelter_delay_std = 0;
    double Pct_households_sheltering = 0;
    bool High_income_households_sheltering = false;
    double Early_shelter_rate = 0.0;
    double Shelter_decay_rate = 0.0;
    bool Household_hospital_map_file_exists = false;
    int Hospital_fixed_staff = 1;
    double Hospital_worker_to_bed_ratio = 1.0;
    double Hospital_outpatients_per_day_per_employee = 0.0;
    double Healthcare_clinic_outpatients_per_day_per_employee = 0;
    int Hospital_min_bed_threshold = 0;
    double Hospitalization_radius = 0.0;
    int Hospital_overall_panel_size = 0;
    int Enable_copy_files = 0;

    //HAZEL Parameters needed for multiple place types (not just hospitals)
    int HAZEL_disaster_start_sim_day = -1;
    int HAZEL_disaster_end_sim_day = -1;
    int HAZEL_disaster_evac_start_offset = 0;
    int HAZEL_disaster_evac_end_offset = 0;
    int HAZEL_disaster_return_start_offset = 0;
    int HAZEL_disaster_return_end_offset = 0;
    double HAZEL_disaster_evac_prob_per_day = 0.0;
    double HAZEL_disaster_return_prob_per_day = 0.0;
    int HAZEL_mobile_van_max = 0;

    Dictionary<int, int> Hospital_ID_total_assigned_size_map;
    Dictionary<int, int> Hospital_ID_current_assigned_size_map;

    public double distance_between_places(Place p1, Place p2)
    {
      return Geo.XYDistance(p1.get_latitude(), p1.get_longitude(), p2.get_latitude(), p2.get_longitude());
    }

    public void init_place_type_name_lookup_map()
    {
    ...
    void get_parameters()
    {
      ...
      Params::get_param_from_string("enable_copy_files", &Enable_copy_files);

      // geography
      Params::get_param_from_string("msa_file", MSA_file);
      Params::get_param_from_string("counties_file", Counties_file);
      Params::get_param_from_string("states_file", States_file);
      ...
      if (Global::Enable_Group_Quarters)
      {
        ...
        Params::get_param_from_string("college_dorm_mean_size", &College_dorm_mean_size);
        Params::get_param_from_string("military_barracks_mean_size", &Military_barracks_mean_size);
        Params::get_param_from_string("prison_cell_mean_size", &Prison_cell_mean_size);
        Params::get_param_from_string("nursing_home_room_mean_size", &Nursing_home_room_mean_size);

        Params::get_param_from_string("school_fixed_staff", &School_fixed_staff);
        Params::get_param_from_string("school_student_teacher_ratio", &School_student_teacher_ratio);
        Params::get_param_from_string("college_fixed_staff", &College_fixed_staff);
        Params::get_param_from_string("college_resident_to_staff_ratio", &College_resident_to_staff_ratio);
        Params::get_param_from_string("prison_fixed_staff", &Prison_fixed_staff);
        Params::get_param_from_string("prison_resident_to_staff_ratio", &Prison_resident_to_staff_ratio);
        Params::get_param_from_string("nursing_home_fixed_staff", &Nursing_home_fixed_staff);
        Params::get_param_from_string("nursing_home_resident_to_staff_ratio",
            &Nursing_home_resident_to_staff_ratio);
        Params::get_param_from_string("military_fixed_staff", &Military_fixed_staff);
        Params::get_param_from_string("military_resident_to_staff_ratio", &Military_resident_to_staff_ratio);
      }

      // household shelter parameters
      if (Global::Enable_Household_Shelter)
      {
        Params::get_param_from_string("shelter_in_place_duration_mean", &Shelter_duration_mean);
        Params::get_param_from_string("shelter_in_place_duration_std", &Shelter_duration_std);
        Params::get_param_from_string("shelter_in_place_delay_mean", &Shelter_delay_mean);
        Params::get_param_from_string("shelter_in_place_delay_std", &Shelter_delay_std);
        Params::get_param_from_string("shelter_in_place_compliance", &Pct_households_sheltering);
        int temp_int;
        Params::get_param_from_string("shelter_in_place_by_income", &temp_int);
        High_income_households_sheltering = (temp_int == 0 ? false : true);
        Params::get_param_from_string("shelter_in_place_early_rate", &Early_shelter_rate);
        Params::get_param_from_string("shelter_in_place_decay_rate", &Shelter_decay_rate);
      }

      // household evacuation parameters
      if (Global::Enable_HAZEL)
      {
        Params::get_param_from_string("HAZEL_disaster_start_sim_day", &HAZEL_disaster_start_sim_day);
        Params::get_param_from_string("HAZEL_disaster_end_sim_day", &HAZEL_disaster_end_sim_day);
        Params::get_param_from_string("HAZEL_disaster_evac_start_offset", &HAZEL_disaster_evac_start_offset);
        Params::get_param_from_string("HAZEL_disaster_evac_end_offset", &HAZEL_disaster_evac_end_offset);
        Params::get_param_from_string("HAZEL_disaster_return_start_offset", &HAZEL_disaster_return_start_offset);
        Params::get_param_from_string("HAZEL_disaster_return_end_offset", &HAZEL_disaster_return_end_offset);
        Params::get_param_from_string("HAZEL_disaster_evac_prob_per_day", &HAZEL_disaster_evac_prob_per_day);
        Params::get_param_from_string("HAZEL_disaster_return_prob_per_day", &HAZEL_disaster_return_prob_per_day);
        Params::get_param_from_string("HAZEL_mobile_van_max", &HAZEL_mobile_van_max);
      }
      ...
      if (Global::Enable_Hospitals)
      {
        ...
        Params::get_param_from_string("hospital_worker_to_bed_ratio", &Hospital_worker_to_bed_ratio);
        Hospital_worker_to_bed_ratio = (Hospital_worker_to_bed_ratio == 0.0 ? 1.0 : Hospital_worker_to_bed_ratio);
        Params::get_param_from_string("hospital_outpatients_per_day_per_employee", &Hospital_outpatients_per_day_per_employee);
        Params::get_param_from_string("healthcare_clinic_outpatients_per_day_per_employee", &Healthcare_clinic_outpatients_per_day_per_employee);
        Params::get_param_from_string("hospital_min_bed_threshold", &Hospital_min_bed_threshold);
        Params::get_param_from_string("hospitalization_radius", &Hospitalization_radius);
        Params::get_param_from_string("hospital_fixed_staff", &Hospital_fixed_staff);
...
int msaLength = strlen(Global::MSA_code);
    if(msaLength == 5) {
      FILE* msafp = Utils::fred_open_file(MSA_file);
      if(msafp == NULL) {
...
hosp.set_bed_count(bed_count);
      if(hosp.get_daily_patient_capacity(0) == -1) {
        int capacity = static_cast<int>(static_cast<double>((*itr).num_workers_assigned))
            * Hospital_outpatients_per_day_per_employee;
hosp.set_daily_patient_capacity(capacity);
      }
      if(hosp.get_subtype() != Place::SUBTYPE_MOBILE_HEALTHCARE_CLINIC) {
        if(bed_count<Hospital_min_bed_threshold) { // This place is not have enough "bed" to be considered for overnight
...
int number_of_units = 0;
      if(strcmp(tokens[gq_type], "C") == 0) {
        number_of_units = capacity / College_dorm_mean_size;
        place_subtype = Place::SUBTYPE_COLLEGE;
      }
      if(strcmp(tokens[gq_type], "M") == 0) {
        number_of_units = capacity / Military_barracks_mean_size;
        place_subtype = Place::SUBTYPE_MILITARY_BASE;
      }
      if(strcmp(tokens[gq_type], "P") == 0) {
        number_of_units = capacity / Prison_cell_mean_size;
        place_subtype = Place::SUBTYPE_PRISON;
      }
      if(strcmp(tokens[gq_type], "N") == 0) {
        number_of_units = capacity / Nursing_home_room_mean_size;
...
void reassign_workers_to_places_of_type(char place_type, int fixed_staff, double staff_ratio)
{
  int number_places = this.places.size();
...
void prepare_primary_care_assignment()
{
  ...
  if (Global::Enable_Hospitals && this.is_load_completed() && Global::Pop.is_load_completed())
  {
    ...
    assert(Hospital_overall_panel_size > 0);
    ...
    for (int i = 0; i < this.hospitals.size(); ++i)
    {
      ...
      if (hosp.get_subtype() != Place::SUBTYPE_MOBILE_HEALTHCARE_CLINIC)
      {
        proprtn_of_total_panel = static_cast<double>(hosp.get_daily_patient_capacity(0))
            / static_cast<double>(Hospital_overall_panel_size);
      }
      Hospital_ID_total_assigned_size_map.insert(std::pair<int, int>(hosp.get_id(), ceil(proprtn_of_total_panel * tot_pop_size)));
      Hospital_ID_current_assigned_size_map.insert(std::pair<int, int>(hosp.get_id(), 0));
    }
        ...
        if (distance <= Hospitalization_radius)
        {
          if (check_insurance)
          {
            ...
            if (hospital.accepts_insurance(per_insur))
            {
              ...
              if (Hospital_ID_current_assigned_size_map.at(hospital.get_id())
                  < Hospital_ID_total_assigned_size_map.at(hospital.get_id()))
              {
...
void select_households_for_shelter()
{
  ...
  int num_sheltering = 0.5 + Pct_households_sheltering * this.households.size();
...
void shelter_household(Household* h)
{
  ...
  int shelter_start_day = 0.4999999
      + Random::draw_normal(Shelter_delay_mean, Shelter_delay_std);
  ...
  int shelter_duration = 0.4999999
      + Random::draw_normal(Shelter_duration_mean, Shelter_duration_std);
...
void select_households_for_evacuation()
{
  ...
  for (int i = 0; i < num_households; ++i)
  {
    ...
    {
      if (Random::draw_random() < HAZEL_disaster_evac_prob_per_day)
      {
        ...
        {
          if (Random::draw_random() < HAZEL_disaster_evac_prob_per_day || k == return_end_sim_day)
          {
            if (k > j)
...
int get_HAZEL_disaster_start_sim_day()
{
  return HAZEL_disaster_start_sim_day;
}

int get_HAZEL_disaster_end_sim_day()
{
...
void setup_HAZEL_mobile_vans()
{
  ...
  if (HAZEL_mobile_van_max >= static_cast<int>(temp_hosp_vec.size()))
  {
    for (int i = 0; i < static_cast<int>(temp_hosp_vec.size()); ++i)
    {
      //The Mobile Healthcare Clinics close after days
      temp_hosp_vec.at(i).set_close_date(HAZEL_disaster_end_sim_day + Hospital::get_HAZEL_mobile_van_open_delay()
  ...
  else
  {
    ...
    for (int i = HAZEL_mobile_van_max; i < static_cast<int>(temp_hosp_vec.size()); ++i)
    {
