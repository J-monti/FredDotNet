...
namespace Fred
{
  ...
  {
    Epidemic* get_epidemic(Disease* disease)
    {
  ...
  this.actually_infectious_people.clear();
    ...
    protected virtual void report_disease_specific_stats(DateTime day)
    {
    }


protected void track_value(int day, string key, int value)
{
  char key_str[80];
  if (this.id == 0)
  {
  ...
  Global::Daily_Tracker.set_index_key_pair(day, key_str, value);
    ...
    protected void track_value(int day, string key, double value)
{
  char key_str[80];
  if (this.id == 0)
  {
  ...
  Global::Daily_Tracker.set_index_key_pair(day, key_str, value);
    ...
    protected void track_value(int day, string key, string value)
{
  char key_str[80];
  if (this.id == 0)
  {
...
std::strcpy(cstr, line.c_str());
      var tmap = new EpidemicTimeStepMap();
int n = sscanf(cstr,
...
void print_stats(int day)
{
  ...
  track_value(day, (string)"S", this.susceptible_people);
  track_value(day, (string)"E", this.exposed_people);
  track_value(day, (string)"I", this.infectious_people);
  track_value(day, (string)"Is", this.people_with_current_symptoms);
  track_value(day, (string)"R", this.removed_people);
  if (this.disease.get_natural_history().is_case_fatality_enabled())
  {
    track_value(day, (string)"CF", this.daily_case_fatality_count);
    track_value(day, (string)"TCF", this.total_case_fatality_count);
    track_value(day, (string)"CFR", case_fatality_rate);
  }
  track_value(day, (string)"M", this.immune_people);
  track_value(day, (string)"P", this.prevalence_count);
  track_value(day, (string)"C", this.incidence);
  track_value(day, (string)"Cs", this.symptomatic_incidence);
  track_value(day, (string)"AR", this.attack_rate);
  track_value(day, (string)"ARs", this.symptomatic_attack_rate);
  track_value(day, (string)"RR", this.RR);
...
void report_age_of_infection(int day)
{
  ...
  track_value(day, (string)"Age_at_infection", mean_age);

  switch(Global::Report_Age_Of_Infection) {
    case 1:
      track_value(day, (string)"Infants", infants);
      track_value(day, (string)"Toddlers", toddlers);
      track_value(day, (string)"Preschool", pre_school);
      track_value(day, (string)"Students", elementary + high_school);
      track_value(day, (string)"Elementary", elementary);
      track_value(day, (string)"Highschool", high_school);
      track_value(day, (string)"Young_adults", young_adults);
      track_value(day, (string)"Adults", adults);
      track_value(day, (string)"Elderly", elderly);
      break;
    case 2:
      track_value(day, (string)"Infants", infants);
      track_value(day, (string)"Toddlers", toddlers);
      track_value(day, (string)"Pre-k", pre_school);
      track_value(day, (string)"Elementary", elementary);
      track_value(day, (string)"Highschool", high_school);
      track_value(day, (string)"Young_adults", young_adults);
      track_value(day, (string)"Adults", adults);
      ...
      break;
    case 3:
      track_value(day, (string)"0_4", pre_school);
      track_value(day, (string)"5_17", high_school);
      track_value(day, (string)"18_49", young_adults);
      track_value(day, (string)"50_64", adults);
      track_value(day, (string)"65_up", elderly);
      break;
    case 4:
      for (int i = 0; i <= Demographics::MAX_AGE; ++i)
      {
...
void report_serial_interval(int day)
{
  ...
  track_value(day, (string)"Tg", mean_serial_interval);
}
...
age_count[g1][g2]++;
  ...
  //Store for daily output file
  track_value(day, (string)"T_4_to_4", age_count[0][0]);
track_value(day, (string)"T_4_to_18", age_count[0][1]);
track_value(day, (string)"T_4_to_64", age_count[0][2]);
track_value(day, (string)"T_4_to_99", age_count[0][3]);
track_value(day, (string)"T_18_to_4", age_count[1][0]);
track_value(day, (string)"T_18_to_18", age_count[1][1]);
track_value(day, (string)"T_18_to_64", age_count[1][2]);
track_value(day, (string)"T_18_to_99", age_count[1][3]);
track_value(day, (string)"T_64_to_4", age_count[2][0]);
track_value(day, (string)"T_64_to_18", age_count[2][1]);
track_value(day, (string)"T_64_to_64", age_count[2][2]);
track_value(day, (string)"T_64_to_99", age_count[2][3]);
track_value(day, (string)"T_99_to_4", age_count[3][0]);
track_value(day, (string)"T_99_to_18", age_count[3][1]);
track_value(day, (string)"T_99_to_64", age_count[3][2]);
track_value(day, (string)"T_99_to_99", age_count[3][3]);
} 
...
void report_group_quarters_incidence(int day)
{
  ...
  //Store for daily output file
  track_value(day, (string)"GQ", G);
  track_value(day, (string)"College", D);
  track_value(day, (string)"Prison", J);
  track_value(day, (string)"Nursing_Home", L);
  track_value(day, (string)"Military", B);
}
...
void report_place_of_infection(int day)
{
  ...
  //Store for daily output file
  track_value(day, (string)"X", X);
  track_value(day, (string)"H", H);
  track_value(day, (string)"Nbr", N);
  track_value(day, (string)"Sch", S);
  track_value(day, (string)"Cls", C);
  track_value(day, (string)"Wrk", W);
  track_value(day, (string)"Off", O);
  track_value(day, (string)"Hosp", M);
}
...
void report_distance_of_infection(int day)
{
  ...
  //Store for daily output file
  track_value(day, (string)"Dist", 1000 * ave_dist);
}
...
void get_imported_infections(int day)
{
  ...
  for (int i = 0; i < this.imported_cases_map.size(); ++i)
  {
    EpidemicTimeStepMap tmap = this.imported_cases_map[i];
...
protected virtual void update(int day)
{
